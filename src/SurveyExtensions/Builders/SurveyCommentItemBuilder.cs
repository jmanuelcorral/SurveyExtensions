namespace SurveyExtensions.Builders
{
        ...
        IBuilder<SurveyItem> where TEntity : new()
    {
        ...
        public SurveyCommentItemBuilder<TEntity> IsNotRequired()
        {
            _item.IsRequired = false;
            return this;
        }

        public SurveyCommentItemBuilder<TEntity> IsVisible()
        {
            _item.Visible = true;
            return this;
        }

        public SurveyCommentItemBuilder<TEntity> IsNotVisible()
        {
            _item.Visible = false;
            return this;
        }
